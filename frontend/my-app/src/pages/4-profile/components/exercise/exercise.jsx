...
const Exercise = () => {
  ...
  const sample4={id:4, name:'push up', description:'better chest ', type:'chest', video:null}
  const sample5={id:5, name:'lat pull down', description:'side of your lat', type:'back', video:null}
  const sample6={id:6, name:'deadlift', description:'strong leg', type:'leg', video:null}
